...
export async function PATCH(request: Request) {
  ...
  try {
    await withDiscoveryLease(async () => writeDiscoverySetting(EDITORIAL_CONFIG_KEY, { enabled: body.enabled, provider: body.provider, dailyReviewLimit: body.dailyReviewLimit, jevMonthlyBudgetUsd: body.jevMonthlyBudgetUsd, dailyBudgetCny: body.dailyBudgetCny ?? (await getEditorialConfig()).dailyBudgetCny }));
