...
Production release `20260917T152400`, parent `20260916T210459`, source `cb5a375fee7d7b4f1d443d37fee80d2a07b72e0a`. On 2026-09-18 the public connectivity response reported these release/parent ids and `mainland_internal`; `/opt/context-reader-current` resolved to `/opt/context-reader-releases/20260917T152400`, and the server release-state confirmed this exact source revision.

The 2026-09-17 acceptance record reports 101 regressions, production builds, release contracts, egress checks, complete public structured/streamed lookups, fresh US/UK audio, account/sync/Admin boundaries, seven-service health, a 16-table backup restore and current/parent rollback images. Only app/caddy were recreated. That evidence remains in `docs/product-journey.md`; the 2026-09-18 source synchronization does not claim to rerun all live acceptance checks. Physical-device audio, browser migration and final visual acceptance remain separate; the previous public browser navigation timed out.
