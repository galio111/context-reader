...
Accepted production `20260920T234500`, parent `20260920T233000`, source `b57f26acb2cd07e3bde2bcb55a733bf12db2a646`. The intermediate date-budget release `20260920T233000` has parent `20260920T172600` and source `de4cf156add49d11729a91f7791ddac4cdd512e3`. Public mainland identity matches the active symlink. Only app/caddy were recreated. Production health and the accepted-parent rollback image pass; the latest database backup restores all 16 public tables. Local production build, protected contracts, egress audit and 150 distinct regressions passed (149 combined tests plus the added provider-ledger case, followed by 9 targeted final tests).

Authenticated Admin confirms the 2026-09-21 uncapped trial, unchanged base CNY 1, enabled 06:00 Shanghai automation/email, both provider keys configured and no premature Jev adoption. Invalid trial dates are rejected, and legacy settings saves preserve the trial and adoption opt-in. No AI inference was dispatched; the production ledger stayed at 384 legacy calls / CNY 1.637930 and the route-filtered execution count remained 284. Full reading/account model smoke was not repeated because paid work tonight was expressly cancelled. Public read-only and authorization boundary checks are retained with acceptance logs under artifacts/editorial-adoption-*. Actual Jev inference, reference agreement, daily supply and future replacement costs remain awaiting the trial.
