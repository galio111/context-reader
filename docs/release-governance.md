...
## Current accepted CET revision 4 release

Accepted `20260925T163006`, parent `20260924T184912`, source `b6c64c6e089481c0153cdc0f48c805cf7c08528f`; public backend is mainland_internal. The regional npm build registry preserves lockfile versions and integrity verification. The stable entrypoint verified the exact 42-file delta and only recreated app/caddy. Actual public checks, backup restore and rollback-image evidence: [revision 4 release](cet-revision4-release.md). Subsequent evidence-only main commits do not change the production source identity.
