...
Accepted production `20260922T072500`, parent `20260922T070500`, source `022128281711473bf6c6af575885ae938b2b08ba`. Cumulative model controls preserve the accepted accented-lookup/media changes. Public identity, admin boundaries, MiMo real probe, CNY 1.50 policy and enabled 01:00 scheduler passed. 141 focused/critical tests, production builds, release contracts, seven-service health, 16-table backup restore and accepted current/parent rollback images passed. No 60-article full-day production trial was performed. MiMo is selectable; Jev is unconfigured and disabled. Detailed evidence and limitations are in model-control.md and product-journey.md.
