...
Accepted production `20260922T083448`, parent `20260922T074500`, source `4d6b38840191d79acd4932b81ec37ae7b8d2c2e5`. Read-only Admin reporting now separates feature/model costs, user activity, quota management and invitations. Public mainland identity/symlink, authenticated reports and cost breakdown reconciliation, account/sync/Admin boundaries, actual configured MiMo contextual lookup with sentence translation, Flash dictionary and full translation pass. Only app/caddy recreated. Seven-service health, isolated 16-table backup restore and accepted current/parent rollback images pass. Local build, release contracts and 109 critical/model/fallback/report tests pass; desktop/mobile browser fixture verification covers sticky navigation, expansion, filters and no document overflow. Two temporary reading acceptance accounts were removed. Existing capacity limitations from the parent remain unchanged; this UI/reporting release does not certify unrestricted 1,000-DAU capacity. Historical missing token/model data is explicitly unpriced. See admin-usage-report.md, capacity-plan.md and product-journey.md.
