...
Implementation complete; deployment and final browser evidence are recorded in product-journey.md after acceptance. Dedicated tests cover Shanghai boundaries, multi-provider fallback, cache pricing, unknown charges, scope totals, cross-day joins and pagination-independent aggregates. HTTP fixture validation covers 1,203 rows, auth, invalid filters, empty days and no-store responses.
